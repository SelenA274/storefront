      ...
      <section className="py-16">
        ...
        <div className="flex gap-4 px-8 overflow-x-scroll scrollbar-hide">
          {[
            ...
            { name: "Hair Care", sub: "Shine & Strength", href: "/products?department=hair-care", img: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=800&q=80" },
            { name: "Body Care", sub: "Nourish & Glow", href: "/products?department=body-care", img: "https://images.unsplash.com/photo-1600857544200-b2f666a9a2ec?w=800&q=80" },
          ].map((cat) => (
